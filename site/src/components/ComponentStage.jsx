    ...
    const items = [
      {
        ...
        a: 'A production-ready motion library for React, offering spring physics, gestures, and layout animations.',
      },
      {
        id: 1,
        q: 'What is React Three Fiber?',
        a: 'A React renderer for Three.js — lets you build 3D scenes declaratively with React components.',
      },
      {
        id: 2,
        q: 'Can I drop any React component?',
        a: 'Yes! This stage renders arbitrary React components. Paste your JSX in the editor and hit render.',
      },
    ];
    return (
      <div
          ...
          >
            ...
            >
              ...
              <motion.span
                ...
                style={{ display: 'inline-block', color: '#a78bfa' }}
              >
                ▾
              </motion.span>
            </motion.button>
    ...
    return (
      <div style={{ textAlign: 'center' }}>
        <motion.div
          animate={{
            background: selected,
            boxShadow: `0 0 60px ${selected}80`,
          }}
        ...
        >
          {colors.map(c => (
            <motion.button
              ...
              animate={{
                outline:
                  selected === c ? `3px solid white` : '3px solid transparent',
                outlineOffset: 2,
              }}
              style={{
                width: 32,
...
export default function ComponentStage() {
  ...
  return (
    <div>
      ...
      >
        Each tab renders a live React component inside the stage — swap,
        interact, and extend.
      </p>
    </div>
  );
