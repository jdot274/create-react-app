...
Claude is currently failing to work well on this project. Improvement is required or the user will uninstall.
...
- Stop explaining what to do and just do it
...
- Never tell the user a tool doesn't exist if they assert it does — search harder
...
- "Here's how you do it" is a failure mode — do it
...
- If a command fails, diagnose and fix — don't hand it back to the user
