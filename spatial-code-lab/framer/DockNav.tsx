...
export default function DockNav({
  ...
  return (
    <div style={{
      ...
      borderRadius: 9999,
      boxShadow: "0 20px 60px rgba(0,0,0,0.55), 0 0 30px rgba(59,130,246,0.08), inset 0 0 0 0.5px rgba(255,255,255,0.04)",
        ...
        return (
          <button
            ...
            style={{
              ...
              border: "none", background: isActive
                ? "rgba(59,130,246,0.18)"
                : isHovered ? "rgba(255,255,255,0.07)" : "transparent",
              color: isActive ? "#60a5fa" : isHovered ? "#f8fafc" : "rgba(248,250,252,0.38)",
...
addPropertyControls(DockNav, {
  position: {
    type: ControlType.Enum, title: "Position", defaultValue: "bottom",
    options: ["bottom", "top"], optionTitles: ["Bottom", "Top"],
  },
  activeId: {
    type: ControlType.String, title: "Active ID", defaultValue: "hero",
