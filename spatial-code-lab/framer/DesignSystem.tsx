...
const ELEVATIONS = [
  ...
  {
    label: 'E3 — High',
    shadow: '0 20px 60px rgba(0,0,0,0.45), 0 0 30px rgba(59,130,246,0.08)',
            ...
            {TYPE_SCALE.map((t, i) => (
              <div
                ...
                style={{
                  ...
                  gap: 16,
                  paddingBottom: 14,
                  marginBottom: i < TYPE_SCALE.length - 1 ? 14 : 0,
                  borderBottom:
              ...
              >
                <span
                  style={{
                    ...
                    color: T.text,
                    lineHeight: 1.1,
                    letterSpacing: t.weight === 600 ? '0.1em' : '-0.02em',
                    flex: 1,
                    minWidth: 0,
                    overflow: 'hidden',
                    textOverflow: 'ellipsis',
            ...
            <SectionCard title="Border Radius">
              ...
              >
                {RADII.map(r => (
                  ...
                  >
                    <span
                      style={{ fontSize: 9, color: T.blue4, fontWeight: 600 }}
                    >
                      {r}px
                    </span>
                  </div>
...
addPropertyControls(DesignSystem, {
  ...
  description: {
    ...
    title: 'Description',
    defaultValue:
      'Color palette, typography scale, spacing, and elevation tokens',
