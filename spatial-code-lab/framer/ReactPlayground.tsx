        ...
        {tabs.map((t, i) => (
          <button
            ...
            style={{
              ...
              boxShadow:
                active === i ? '0 0 16px rgba(59,130,246,0.1)' : 'none',
              transition: 'all 0.2s',
            }}
          >
            {t}
        ...
        >
          <div
            style={{
              ...
              animation:
                'scl-modalIn 0.3s cubic-bezier(0.34,1.56,0.64,1) forwards',
          ...
          >
            ...
            >
              This modal is a React component with glassmorphism styling,
              backdrop blur, and spring animation. Add any HTML, CSS, JS, or
              React content here.
            </p>
            <div
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  hovBar === i ? '0 0 16px rgba(59,130,246,0.4)' : 'none',
                transition: 'all 0.2s',
                cursor: 'pointer',
              }}
            />
            <span style={{ fontSize: 9, color: 'rgba(248,250,252,0.25)' }}>
              {days[i]}
            </span>
          </div>
        ))}
...
export default function ReactPlayground({
  ...
  useEffect(() => {
    injectCSS('scl-playground-css', CSS);
  }, []);
  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: 64 }}>
        ...
        >
          Live React demos — toggle, tab, modal, and dashboard widgets
        </p>
      </div>
