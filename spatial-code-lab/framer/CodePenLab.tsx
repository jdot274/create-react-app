...
function GlassMorphDemo() {
  return (
    <div style={{
      ...
      <div style={{
        width: 200, height: 120, borderRadius: 20,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: 14, backfaceVisibility: "hidden",
  ...
  return (
    <div style={{
      ...
      <span style={{
        ...
        color: T.cyan4, animation: "scl-neonPulse 2.2s ease-in-out infinite",
      }}>SPATIAL</span>
    </div>
  )
}
...
// ── Single card ───────────────────────────────────────────────
function PenCard({
  src, title, tag, tagColor, DemoComponent, penHeight, cornerRadius, hovered, onHover,
}: {
  src?: string; title: string; tag: string; tagColor: string;
  DemoComponent: () => JSX.Element; penHeight: number; cornerRadius: number;
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ fontSize: 12, fontWeight: 600, color: T.textM }}>{title}</span>
        <span style={{
      ...
      <div style={{ height: penHeight }}>
        {src ? (
          <LazyIframe src={src} height={penHeight} />
        ) : (
          <DemoComponent />
        )}
      </div>
...
export default function CodePenLab({
  ...
  useEffect(() => { injectCSS("scl-codepen-css", CSS) }, [])
  ...
  return (
    <div style={{
      width: "100%", padding: "96px 0", boxSizing: "border-box",
      fontFamily: "'Inter', -apple-system, sans-serif",
      ...
      <div style={{
        ...
        <p style={{ fontSize: 12, color: T.textM, lineHeight: 1.6, margin: 0 }}>
          <strong style={{ color: T.blue4 }}>Adding real CodePen embeds:</strong>{" "}
          Copy the CodePen embed URL (e.g.{" "}
          <code style={{ background: "rgba(255,255,255,0.08)", padding: "1px 6px", borderRadius: 4, fontSize: 11 }}>
            codepen.io/user/embed/abc123/?default-tab=result&theme-id=dark
          </code>
          ) and paste it into the <code style={{ background: "rgba(255,255,255,0.08)", padding: "1px 6px", borderRadius: 4, fontSize: 11 }}>pen1.src</code> property in the Framer panel.
        </p>
      </div>
    </div>
  )
...
addPropertyControls(CodePenLab, {
  headline:    { type: ControlType.String,  title: "Headline",    defaultValue: "Code Experiments" },
  label:       { type: ControlType.String,  title: "Label",       defaultValue: "● CodePen Lab" },
  description: { type: ControlType.String,  title: "Description", defaultValue: "Live CSS demos — swap in any CodePen embed URL" },
  columns: {
    type: ControlType.Enum, title: "Columns", defaultValue: 2,
    options: [1, 2], optionTitles: ["1 Column", "2 Columns"],
  },
  penHeight:     { type: ControlType.Number, title: "Pen Height",  defaultValue: 280, min: 160, max: 600, step: 20 },
  cornerRadius:  { type: ControlType.Number, title: "Radius",      defaultValue: 20,  min: 0,   max: 32,  step: 2 },
  pen1: {
    type: ControlType.Object, title: "Pen 1",
    controls: {
      title: { type: ControlType.String, title: "Title", defaultValue: "Glass Morphism" },
      src:   { type: ControlType.String, title: "Embed URL", defaultValue: "", description: "CodePen embed URL" },
      tag:   { type: ControlType.String, title: "Tag",   defaultValue: "CSS" },
    },
  },
  pen2: {
    type: ControlType.Object, title: "Pen 2",
    controls: {
      title: { type: ControlType.String, title: "Title", defaultValue: "3D Card Flip" },
      src:   { type: ControlType.String, title: "Embed URL", defaultValue: "" },
      tag:   { type: ControlType.String, title: "Tag",   defaultValue: "CSS" },
    },
  },
  pen3: {
    type: ControlType.Object, title: "Pen 3",
    controls: {
      title: { type: ControlType.String, title: "Title", defaultValue: "Neon Text FX" },
      src:   { type: ControlType.String, title: "Embed URL", defaultValue: "" },
      tag:   { type: ControlType.String, title: "Tag",   defaultValue: "CSS" },
    },
  },
  pen4: {
    type: ControlType.Object, title: "Pen 4",
    controls: {
      title: { type: ControlType.String, title: "Title", defaultValue: "CSS Loader" },
      src:   { type: ControlType.String, title: "Embed URL", defaultValue: "" },
      tag:   { type: ControlType.String, title: "Tag",   defaultValue: "CSS" },
    },
  },
